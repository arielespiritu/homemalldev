									...
									<div class="widget-main"  style="height:300px; overflow-y: scroll;">
										<div class="span12">
											<div class="control-group span4">
												...
												<div class="controls">
													<div class="span12">
														<select class="span12" style="width:100%;" onChange="showSelectedVariants(this.value)" id="description_type" data-placeholder="Choose Variant Type" >
															<option value="" />
...
function showSelectedVariants(id)
{
	alert(id);
